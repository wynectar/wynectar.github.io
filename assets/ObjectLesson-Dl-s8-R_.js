import{Q as u}from"./QueryFunction-0i9GG7Jk.js";import{d as p,r as b,c as g,k as m,F as h,q as f,e as v,h as x,i as _,j as w,m as t,_ as y}from"./index-B3qWU_rR.js";const i=[{question:"vitepress 打包时报错：[vitepress] 1 dead link(s) found.",tag:"VitePress",answer:`<ol>
        ...
        </ol>`},{question:"提交时报错并丢失代码：husky - pre-commit script failed (code 1) ，怎么找回?",tag:"Git",answer:`<ol>
        ...
        </ol>`}],q={class:"lesson"},k=["innerHTML"],L=p({__name:"ObjectLesson",setup(N){const s=b(i),l={},o=[];i.forEach(e=>{l[e.tag]||(l[e.tag]=!0,o.push({label:e.tag,value:e.tag}))});function d(e){let a=e.selectVal?i.filter(n=>n.tag===e.selectVal):i;const r=e.inputVal||"";s.value=a.filter(n=>n.answer.includes(r)||n.tag.includes(r))}return(e,a)=>{const r=w("n-card");return t(),g("div",q,[m(u,{options:o,style:{"margin-bottom":"20px"},top:"20px",onQuery:d}),(t(!0),g(h,null,f(s.value,(n,c)=>(t(),v(r,{key:c,title:`${n.question}🍎🍎🍎${n.tag}`,"header-style":"background:rgba(24, 160, 88, 0.2)","content-style":"background:rgba(24, 160, 88, 0.1)"},{default:x(()=>[_("div",{innerHTML:n.answer,class:"answer"},null,8,k)]),_:2},1032,["title"]))),128))])}}}),S=y(L,[["__scopeId","data-v-c44baa25"]]);export{S as default};
