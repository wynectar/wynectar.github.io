import{Q as u}from"./QueryFunction-ylKBVxWd.js";import{d as p,r as b,c as g,i as m,F as h,j as x,k as _,l as f,f as w,m as v,h as i,_ as y}from"./index-DzEP_0Bp.js";const t=[{question:"提交时报错并丢失代码：husky - pre-commit script failed (code 1) ，怎么找回?",tag:"git",answer:`<ol>
        ...
        </ol>`}],k={class:"lesson"},q=["innerHTML"],N=p({__name:"ObjectLesson",setup(B){const s=b(t),l={},a=[];t.forEach(e=>{l[e.tag]||(l[e.tag]=!0,a.push({label:e.tag,value:e.tag}))});function d(e){let o=e.selectVal?t.filter(n=>n.tag===e.selectVal):t;const r=e.inputVal||"";s.value=o.filter(n=>n.answer.includes(r)||n.tag.includes(r))}return(e,o)=>{const r=v("n-card");return i(),g("div",k,[m(u,{options:a,style:{"margin-bottom":"20px"},top:"20px",onQuery:d}),(i(!0),g(h,null,x(s.value,(n,c)=>(i(),_(r,{key:c,title:`${n.question}🍎🍎🍎${n.tag}`,"header-style":"background:rgba(24, 160, 88, 0.2)","content-style":"background:rgba(24, 160, 88, 0.1)"},{default:f(()=>[w("div",{innerHTML:n.answer,class:"answer"},null,8,q)]),_:2},1032,["title"]))),128))])}}}),S=y(N,[["__scopeId","data-v-c44baa25"]]);export{S as default};
