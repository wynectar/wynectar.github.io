<template>
  <div class="magnifier" :style="{ '--size': `${magnifierSize}px`, '--scale': scale }">
    <img :src="imageSrc" alt="小图片" class="magnifier-small absolute" @mousemove="handleMouseMove" />
    <div class="mask absolute" :style="{ left: `${x}px`, top: `${y}px` }"></div>
    <div class="magnifier-large absolute">
      <img :src="imageSrc" alt="大图片" class="absolute"
...
<script>
import imageSrc from '@/assets/imgs/shaohua.png'
export default {
  props: {
    smallImageSrc: {
      type: String,
      default: "@/assets/imgs/shaohua.png"
    },
    largeImageSrc: {
      type: String,
      default: "@/assets/imgs/shaohua.png"
...
.magnifier-small:hover~.magnifier-large,
.magnifier-small:focus~.magnifier-large,
