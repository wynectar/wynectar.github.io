import{Q as u}from"./QueryFunction-vI416WJU.js";import{d as p,r as b,c as g,f as h,F as m,g as x,h as _,w as f,a as w,i as v,e as i,_ as y}from"./index-gPywThb7.js";const t=[{question:"Chrome 浏览器渲染页面频繁闪屏导致整个浏览器不能使用！",tag:"Chrome",answer:`<ol>
        ...
        </ol>`},{question:"github master分支下的dist文件夹推送到gh-pages分支",tag:"Github",answer:`<ol>
        ...
        </ol>`}],q={class:"lesson"},N=["innerHTML"],k=p({__name:"ObjectLesson",setup(B){const s=b(t),l={},a=[];t.forEach(e=>{l[e.tag]||(l[e.tag]=!0,a.push({label:e.tag,value:e.tag}))});function d(e){let o=e.selectVal?t.filter(n=>n.tag===e.selectVal):t;const r=e.inputVal||"";s.value=o.filter(n=>n.answer.includes(r)||n.tag.includes(r))}return(e,o)=>{const r=v("n-card");return i(),g("div",q,[h(u,{options:a,style:{"margin-bottom":"20px"},top:"20px",onQuery:d}),(i(!0),g(m,null,x(s.value,(n,c)=>(i(),_(r,{key:c,title:`${n.question}🍎🍎🍎${n.tag}`,"header-style":"background:rgba(24, 160, 88, 0.2)","content-style":"background:rgba(24, 160, 88, 0.1)"},{default:f(()=>[w("div",{innerHTML:n.answer,class:"answer"},null,8,N)]),_:2},1032,["title"]))),128))])}}}),S=y(k,[["__scopeId","data-v-c44baa25"]]);export{S as default};
